  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-40 flex h-full flex-col p-8">
          <motion.p
          ...
          <motion.p
            layoutId={layout ? `title-${card.title}` : undefined}
            className="mt-2 text-left font-sans text-xl font-semibold [text-wrap:balance] text-white"
          >
            {card.title}
          </motion.p>
          <motion.p
            layoutId={layout ? `description-${card.title}` : undefined}
            className="mt-auto max-w-xs text-left font-sans text-sm font-medium [text-wrap:balance] whitespace-pre-wrap text-white md:text-base"
          >
            {card.description}
          </motion.p>
        </div>
