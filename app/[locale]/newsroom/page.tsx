...
export async function generateMetadata({
  ...
  return {
    ...
    description: isKorean
      ? 'Another Doctor의 최신 소식, 기술 업데이트, 치과 AI 혁신 뉴스를 확인하세요.'
      : 'Stay updated with the latest news, tech updates, and dental AI innovation from Another Doctor.',
    keywords: isKorean
      ? [
          'Another Doctor 뉴스',
          '치과 AI 뉴스',
    ...
    openGraph: {
      title: isKorean ? 'Another Doctor 뉴스룸' : 'Another Doctor Newsroom',
      description: isKorean
